...
import com.srping.core.session04.sta.PersonProxy;
import com.srping.core.session04.sta.Woman;
...
public class ProxyStaticDemo {
	...
	public void test() {
		// 不透過代理直接執行
		/*
		 * Person man = new Man(); Person woman = new Woman(); man.work(); woman.work();
		 */
